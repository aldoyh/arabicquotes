...
function updateReadmeTodoist($data, $ReadMeChunk)
{
    ...
    $newContent = "🏆  **" . number_format($karma) . "** Karma Points" . PHP_EOL
        . "🌸  Completed **" . $days_items . "** tasks today" . PHP_EOL
        . "🗓  Completed **" . $week_items . "** tasks this week" . PHP_EOL

        . "✅  Completed **" . number_format($completed_count) . "** tasks so far" . PHP_EOL
        . "⏳  Longest streak is **" . $goals['max_daily_streak']['count'] . "** days" . PHP_EOL;

    // add the updated date
    $date = date('l, F j, Y');
    $newContent .= "📅  Last updated: **" . $date . "**" . PHP_EOL;
